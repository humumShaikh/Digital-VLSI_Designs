...
### LEDs
set_property -dict { PACKAGE_PIN U16   IOSTANDARD LVCMOS33 } [get_ports {red}]
...
set_property -dict { PACKAGE_PIN V14   IOSTANDARD LVCMOS33 } [get_ports {yellow}]
...
set_property -dict { PACKAGE_PIN L1    IOSTANDARD LVCMOS33 } [get_ports {green}]
...
set_property -dict {PACKAGE_PIN U4 IOSTANDARD LVCMOS33} [get_ports {seg[1]}]
set_property -dict {PACKAGE_PIN V4 IOSTANDARD LVCMOS33} [get_ports {seg[2]}]
set_property -dict {PACKAGE_PIN W4 IOSTANDARD LVCMOS33} [get_ports {seg[3]}]
